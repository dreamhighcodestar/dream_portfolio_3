            ...
            <div className="space-y-4 mt-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="https://mail.google.com/mail/u/0/#advanced-search/to=office%40shopfather.ge&query=in%3Asent&isrefinement=true&todisplay=ivanfinan%40gmail.com?compose=new" target="_blank" className="text-gray-400 hover:text-blue-400 transition-colors">
                    ivanfinan@gmail.com
                  </a>
                </div>
              </div>
